...
namespace ElasticLoadGenerator.Commands
{
    public class PurchaseTicketsCommand : ICommand
    {
        ...
        {
            // Update model and disable 
            // start button

            _model.StartEnabled = false;
            _model.StartText = "Running";
        ...
        void Worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            _model.StatusText = "";
            _model.LoadingDatabase = "Load Generation Completed";
        }
