...
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (1,  N'Mozart Violin Concerto No. 5', N'', CAST(N'2015-01-28 00:54:01.870' AS DateTime), 3, 1, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (2,  N'Bach Violin Concerto in A minor', N'', CAST(N'2015-01-29 00:54:01.877' AS DateTime), 3, 2, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (3,  N'Mozart Violin Concerto No. 3', N'', CAST(N'2015-01-30 00:54:01.880' AS DateTime), 3, 3, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (4,  N'Tchaikovsky Violin Concerto, Op. 35', N'', CAST(N'2015-01-31 00:54:01.887' AS DateTime), 3, 4, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (5,  N'Brahms Symphony No. 4', N'', CAST(N'2015-02-01 00:54:01.890' AS DateTime), 3, 5, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (6,  N'Tchaikovsky Symphony No. 6', N'', CAST(N'2015-02-02 00:54:01.893' AS DateTime), 3, 6, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (7,  N'Rachmaninov Symphony No. 2', N'', CAST(N'2015-02-03 00:54:01.897' AS DateTime), 3, 7, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (8,  N'Beethoven Piano Concerto No. 5', N'', CAST(N'2015-02-04 00:54:01.900' AS DateTime), 3, 8, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (9,  N'Mozart Piano Sonata No. 16', N'', CAST(N'2015-02-05 00:54:01.903' AS DateTime), 3, 9, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (10, N'Beethoven Piano Concerto No. 1', N'', CAST(N'2015-02-06 00:54:01.907' AS DateTime), 3, 10, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (11, N'Chopin Nocturnes', N'', CAST(N'2015-02-07 00:54:01.910' AS DateTime), 3, 11, 1, 0)
INSERT [dbo].[Concerts] ([ConcertId], [ConcertName], [Description], [ConcertDate], [Duration], [VenueId], [PerformerId], [SaveToDbServerType]) VALUES (12, N'Chopin Nocturnes', N'', CAST(N'2015-02-08 00:54:01.910' AS DateTime), 3, 12, 1, 0)
...
INSERT [dbo].[Performers] ([PerformerId], [FirstName], [LastName], [Skills], [ContactNbr], [ShortName]) VALUES (1, N'Walla', N'Walla', N'ClassicMusic', CAST(1234567891 AS Numeric(15, 0)), N'Walla Walla Symphony')                
