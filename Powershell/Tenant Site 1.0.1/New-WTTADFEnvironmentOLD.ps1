...
function GetStorageAccount{
    ...
    Process{
        ...
        <#try{
			...
			$storage = New-AzureRMStorageAccount -ResourceGroupName $WTTEnvironmentApplicationName -storageAccountName $azureStorageAccountName -location $global:locationMultiWord -ErrorAction Stop
        } catch {
        ...
        try{
            ...
            $blobAccountkey = Get-AzureRMStorageAccountKey -ResourceGroupName $WTTEnvironmentApplicationName -storageAccountName $azureStorageAccountName
            # Get Context
            $context = New-AzureStorageContext -storageAccountName $azureStorageAccountName -StorageAccountKey $blobAccountkey.Primary
