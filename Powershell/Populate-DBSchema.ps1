            ...
            Else
            {
			    ...
			    $Command.CommandText =
    				"
		    			...
		    			Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (1, N'Conrad Fischer Stands', 1000, N'', 1, 34.0522, -118.2437)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (2, N'Hayden Lawrence Gardens', 1000, N'', 2, 39.7392, -104.9903)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (3, N'Rene Charron Highrise', 1000, N'', 3,  30.3322, -81.6557)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (4, N'Aldo Richter Hall', 1000, N'', 4, 42.3601, -71.0589)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (5, N'Harriet Collier Auditorium', 1000, N'', 5, 42.3314, -83.0458)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (6, N'Samuel Boyle Center', 1000, N'', 6, 43.0481, -76.1474)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (7, N'Millie Stevens Memorial Plaza', 1000, N'', 7, 45.5231, -122.6765)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (8, N'Louisa Zimmerman Stadium', 1000, N'', 8 , 30.2672, -97.7431)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (9, N'Lara Ehrle Amphitheter', 1000, N'', 9, 40.7608, -111.8910)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (10, N'Antione Lacroix Dome', 1000, N'', 10, 47.6062, -122.3321)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (11, N'Claude LAngelier Field', 1000, N'', 11, 47.6588, -117.4260)
						Insert [dbo].[Venues] ([VenueId], [VenueName], [Capacity], [Description], [CityId], [Longitude], [Latitude]) Values (12, N'Maya Haynes Arena', 1000, N'', 10, 47.6062, -122.3321)
