...
function New-WTTEnvironment
{
	...
	Process
	{
		...
		Try
		{
            ...
            Set-WTTIOTEmulatorWebConfig -azureResourceGroupName $azureResourceGroupName -Websitename $iotEmulatorApp -azureDocumentDbName $azureDocumentDbName -documentDbPrimaryKey $documentDbPrimaryKey -documentDbDatabase "iotrawdata" -documentDbCollection "iotrawdata" -wttEventHubName $wttEventHubName -wttServiceBusName $wttServiceBusName
